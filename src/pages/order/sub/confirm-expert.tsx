  ...
  return <View style={{
    ...
    <View style={{
      ...
      <View className="position_item" >
          <Image round src={confirmInfo?.avatar??''} className="position_avatar" />
          <View className="position_title">
            <Text style={{ fontSize: '14px', fontWeight: 400 }}>{confirmInfo?.doctorName}</Text>
            <Text style={{ marginTop: 10, fontSize: '12px', color: '#969799' }}>{confirmInfo?.hospitalName}  {confirmInfo?.jobTitle}</Text>
          </View>
        </View>
    </View>
