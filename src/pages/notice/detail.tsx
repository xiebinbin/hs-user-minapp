...
function NoticeDetail(){
    ...
    return <ScrollView className="detail_container">
      <View className="detail_title">
      【康德“医”闻】失眠精神康复疗愈，擦亮三林康德品牌
      </View>
      <View className="detail_stamp">
        2024年1月1日
      </View>

      <View className="detail_content" dangerouslySetInnerHTML={{ __html: h5 }}>
